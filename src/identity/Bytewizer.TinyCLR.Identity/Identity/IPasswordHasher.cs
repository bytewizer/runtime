namespace Bytewizer.TinyCLR.Identity
{
    ...
    public interface IPasswordHasher
    {
        ...
        byte[] HashPassword(IIdentityUser user, string password);
        ...
        IdentityResult VerifyHashedPassword(IIdentityUser user, byte[] hashedPassword, string providedPassword);
    }
}
